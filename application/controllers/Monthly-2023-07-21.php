...
class Monthly extends CI_Controller {
	...
	public function index($date = '')
	{
		...
		*/
		$jerryID = 44;
		// Next get Jerry's Patient collections 
		...
		$html .= "<div id='jerrypat' class='row'><span class='provname'>Jerry Pt Pay:</span><span class='accounting'>$jfPat</span></div>";
		...
		$html .= "<div id='jerryins' class='row'><span class='provname'>Jerry Ins:</span><span class='accounting'>$jfIns</span></div>";

		// Calc Jerry total
		$jfTotal = $jfpRow->pattotal + $jfiRow->instotal;
		$prettyjfTotal = '$'.number_format( $jfTotal, 2 );
		$html .= "<div id='jerrytotal' class='row'><span class='provname'>Jerry Total Collections:</span><span class='accounting'>$prettyjfTotal</span></div>";
		...
		$html .= "   <div id='jerrydays'><span class='provname'>Jerry Days:</span><span class='accounting'>$jerryDaysTotal</span></div>";
