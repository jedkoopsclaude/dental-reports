...
class CI_Session {
	...
	function sess_read()
	{
		...
		if (isset($session['session_id']))
			log_message('error','SESSION: Session ID='.$session['session_id']);
		...
		if ($this->sess_use_database === TRUE)
		{
			...
			if (isset($row->user_data) AND $row->user_data != '')
			{
				...
				if (is_array($custom_data))
				{
					...
					{
						log_message('error',"*********** Session info: $key=$val");
						$session[$key] = $val;
					}
				}
			}
	...
	function sess_create()
	{
		...
		//log_message("error","*** Created session, about to write cookie.");
		// Write the cookie
		$this->_set_cookie();
	}
	...
	function sess_update()
	{
		...
		if ($this->sess_use_database === TRUE)
		{
			...
			log_message("error","Updated session in database.");
		}
